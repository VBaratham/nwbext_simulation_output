...
# -*- coding: utf-8 -*-
#
# simulation_output documentation build configuration file, created by
# sphinx-quickstart on Sun Mar 24 16:18:21 2019.
#
...
htmlhelp_basename = 'simulation_outputdoc'
...
latex_documents = [
    (master_doc, 'simulation_output.tex', 'simulation\\_output Documentation',
     'Ben Dichter', 'manual'),
]
...
man_pages = [
    (master_doc, 'simulation_output', 'simulation_output Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'simulation_output', 'simulation_output Documentation',
     author, 'simulation_output', 'One line description of project.',
     'Miscellaneous'),
]
...
def run_doc_autogen(_):
   ...
   if spec_doc_rebuild_always or not os.path.exists(spec_output_dir):
      sys.path.append('/Users/bendichter/dev/nwbext_simulation_output/docs')  # needed to enable import of generate_format docs
